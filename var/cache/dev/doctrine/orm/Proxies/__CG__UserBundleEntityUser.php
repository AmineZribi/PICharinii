...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'fullname', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'genre', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
